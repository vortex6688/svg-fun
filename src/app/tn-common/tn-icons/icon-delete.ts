...
@Component({
  ...
  xml:space="preserve" class="icon"><g><path class="st0"
  ...
  <path class="st0" d="M-288.7,392.5h-2.1v-0.8c0-0.3-0.2-0.5-0.5-0.5h-2.4c-0.3,0-0.5,
  0.2-0.5,0.5v0.8h-2.1c-0.3,0-0.5,0.2-0.5,0.5v0.8h8.6V393C-288.2,392.7-288.4,392.5-288.7,
  392.5z M-291.5,392.5h-2v-0.6h2V392.5z"/></g></svg>`,
